  ...
  export default {
    ...
    methods: {
      async rowSave(row, loading, done) {
        ...
        row.chapterContent = this.form.chapterContent;
        chapTerAdd(row).then(() => {
          loading();
      ...
      getImgDe () {
        ...
        return new Promise(function (resolve) {
          ...
          this_.form.chapterContent = this_.form.chapterContent.replace(/<style>[\s\S]*?<\/style>/g,"");
          this_.form.chapterContent = this_.form.chapterContent.replace(/<\/?(?!(p|img))[a-z]+?[^>]*>/gi,"");
          this_.form.chapterContent = this_.form.chapterContent.replace(/&nbsp;/g,' ')
          this_.form.chapterContent = this_.form.chapterContent.replace(/<([\/]?)(p)((:?\s*)(:?[^>]*)(:?\s*))>/g,'\n')
          this_.form.chapterContent = this_.form.chapterContent.replace(/<!(-*)(.*)(-*)>/g,'');
