    ...
    >
      <template slot-scope="scope" slot="menu">
        <el-button
          ...
          icon="el-icon-edit"
          @click="showModalInfo(scope.row, 'operationWithdraw', false , 2)"
        >提现</el-button>
        <el-button
          type="button"
          size="small"
          ...
          icon="el-icon-edit"
          @click="showModalInfo(scope.row, 'operationWithdraw', false , 3)"
        >拒绝</el-button>
      </template>
    </avue-crud>
    <el-dialog
...
export default {
  ...
  methods: {
    // 列表点开模态框
    showModalInfo(row, type, isNotTbale, extractStatus) {
      this.formDatas = row;
